...
//     h1Element.innerText = arrayElement.title;
//     let pElement = document.createElement('p');
//     pElement.classList.add('description');
//     pElement.innerText = arrayElement.monthDuration;
...
//     h2Element.innerText = simpson.name + ' ' + simpson.surname;
//     let h3Element = document.createElement('h3');
//     h3Element.innerText = simpson.age + ' ' + 'years';
//     let pElement = document.createElement('p');
//     pElement.innerText = simpson.info;
//     let photo = document.createElement('img');
//     photo.src = simpson.photo;
//     divElement.append(photo, h2Element, h3Element, pElement);
// }
...
//         duration.innerText = element.monthDuration + ' ' + 'month' + ' ' + '---' + ' ' + element.hourDuration + ' ' + 'hour';
//
...
//         }
//
// divElement.append(titleElement, duration, modules);
// };
