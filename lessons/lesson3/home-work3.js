...
// let users = ['Inna', 'Sany', 'Olya', 'Dimon', 'Igor', 'Tanya', 'Julia', 'Tolik', 'Oleg', 'Artem', 'Taras', 'Inga', 'Rita',
//             'Yaroslav', 'Vasya', 'Lena', 'Valya', 'Semen', 'Nika', 'Ivan'];
//
// let i = 0;
...
//         document.write(`<h2 class="product-title">${product.title} Price - ${product.price}</h2>
